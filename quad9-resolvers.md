  ...
  <label>
    <a href="/service/">
      <svg viewBox="0 0 24 24">
        <use xlink:href="/images/service.svg#icon"></use>
      </svg>
      <span>Service</span>
    </a>
  </label>
...
<a href="/service/service-addresses-and-features/">
  Addresses &amp; Features
  
</a>

<a href="/service/threat-blocking/">
  Threat blocking
...
<div class="dropdown">
  ...
  <label>
    <a href="/news/">
      <svg viewBox="0 0 24 24">
        <use xlink:href="/images/news.svg#icon"></use>
      </svg>
      <span>News</span>
    </a>
  </label>
...
<div class="dropdown">
  ...
  <label>
    <a href="/support/">
      <svg viewBox="0 0 24 24">
        <use xlink:href="/images/support.svg#icon"></use>
      </svg>
      <span>Support</span>
    </a>
  </label>
...
<div class="dropdown">
  ...
  <label>
    <a href="/about/">
      <svg viewBox="0 0 24 24">
        <use xlink:href="/images/about.svg#icon"></use>
      </svg>
      <span>About</span>
    </a>
  </label>
  ...
  <div class="grid container">
    <div class="copyright">
      <a href="//creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank">
        <img src="/images/badges/cc-by-nc-40.png" alt="CC BY-NC-SA 4.0 License">
      </a>
      This work is licensed under a
      <a href="//creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank">CC BY-NC-SA 4.0 License</a>
    </div>
    
<div class="socials">
  <a href="//facebook.com/quad9dns">
    <svg viewBox="0 0 32 32">
      <use xlink:href="/images/socials/facebook.svg#icon"></use>
    </svg>
  </a>
  <a href="//twitter.com/quad9dns">
    <svg viewBox="0 0 32 32">
      <use xlink:href="/images/socials/twitter.svg#icon"></use>
    </svg>
  </a>
  <a href="//mastodon.social/@quad9dns">
    <svg viewBox="0 0 32 32">
      <use xlink:href="/images/socials/mastodon.svg#icon"></use>
    </svg>
  </a>
  <a href="//linkedin.com/company/quad9-dns">
    <svg viewBox="0 0 32 32">
      <use xlink:href="/images/socials/linkedin.svg#icon"></use>
    </svg>
  </a>
  <a href="//youtube.com/channel/UC9XjO28SrM5i6blpyHNoTbg">
    <svg viewBox="0 0 32 32">
      <use xlink:href="/images/socials/youtube.svg#icon"></use>
    </svg>
  </a>
  <a href="//github.com/Quad9DNS">
    <svg viewBox="0 0 32 32">
      <use xlink:href="/images/socials/github.svg#icon"></use>
    </svg>
  </a>
</div>
